...
\begin{figure}
    \centering
    \noindent\makebox[\textwidth]{
    \includegraphics[width=1\textwidth]{Figures/3D_OF/3D_OF_BOTTOM_COMPARE_DIFF.png}}
...
\begin{figure}
    \centering
    \noindent\makebox[\textwidth]{
    \includegraphics[width=1\textwidth]{Figures/3D_OF/3D_OF_BOTTOM_COMPARE_DIFF_F.png}}
...
\begin{figure}
    \centering
    \noindent\makebox[\textwidth]{
    \includegraphics[width=1\textwidth]{Figures/3D_OF/3D_OF_BOTTOM_COMPARE_IN.png}}
