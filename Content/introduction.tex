...
\begin{center}
  ...
  \begin{subfigure}[b]{0.4\textwidth}
    \includegraphics[scale=0.05]{Figures/QFR17 - Dynamic.JPG}
  \end{subfigure}
  %
  \begin{subfigure}[b]{0.4\textwidth}
